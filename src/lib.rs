...
pub use backend::{BackendCapabilities, BackendError, ExecutionBackend, ExecutionPlan, ExecutionPolicy, IdentityBackend, Realization, build_execution_plan};
pub use calculus::{CalculusError, differentiate, evaluate_f64};
pub use compile::{CompileError, CompilerDiagnostic, DiagnosticSeverity, Dialect, LegalityTarget, Lowering, LoweringPass, PassContract, declare_refinement};
...
pub use field::{BoundaryRef, Continuity, DomainRef, ElementFamily, Field, FieldRole, FunctionSpace, InterfaceRef, ValueShape};
pub use form::{EssentialBoundary, FormExpr, FormProgram, Integral, Measure, NaturalBoundary, RobinBoundary};
pub use form_compile::{CompiledForm, FormCompileError, FormCompileOptions, RecognizedFormTerm, compile_form};
pub use generated_verify::{ConvergenceObservation, DerivativeGate, GeneratedVerifyError, ManufacturedSolution, adjoint_dot_gate, finite_difference_gate, infer_dimension, manufacture_forcing, observed_orders, substitute};
...
pub use physics::{PhysicsError, PhysicsLock, freeze as freeze_physics, parse_and_elaborate, validate_lock};
pub use reference::{BoundaryEdge, DofLayout, PiecewiseConstant, ReferenceError, ReferenceMesh2, ReferenceOperator, RobinData, ScalarH1Problem, SparseMatrix, compile_scalar_h1_p1};
pub use reference_mixed::{ElasticityOperator2, IsotropicElasticity2, NedelecOperator2, StokesOperatorP1P1, compile_elasticity_p1_2d, compile_nedelec0_2d, compile_stokes_p1p1_2d};
...
pub use scientific::{CanonicalHeatCase, CouplingGraph, DiscretizationCatalog, PropertyDefinition, ScientificExecutionPlan, ScientificModule, ScientificModel, TimeStateSemantics, derive_coupling_graph, execution_plan, format_scientific_module, parse_scientific_module, resolve_modules, semantic_digest};
...
pub use structural::{AliasAnalysis, AliasClass, Block, BlockKind, DerivativeVariable, DifferentiationStep, EquationDerivativeProfile, IncidenceSystem, IndexReductionPlan, Matching, Schedule, StructuralCompileError, StructuralError, analyze_aliases, compile_schedule, compile_schedule_without_tearing, derivative_profile, maximum_matching, pantelides_plan};
